 ...
 *   https://datatables.net/download/#bm-0.9.2/dt-2.0.3/cr-2.0.0/date-1.5.2/fc-5.0.0/fh-4.0.1/r-3.0.1
 *
 * Included libraries:
 *   Bulma 0.9.2, DataTables 2.0.3, ColReorder 2.0.0, DateTime 1.5.2, FixedColumns 5.0.0, FixedHeader 4.0.1, Responsive 3.0.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bm-0.9.2/dt-2.0.3/cr-2.0.0/date-1.5.2/fc-5.0.0/fh-4.0.1/r-3.0.1",
